...
[System.Serializable, VolumeComponentMenu("CustomPostProcess/Stripes")]
public class StripesEffect : VolumeComponent
{
...
[CustomPostProcess("Stripes", CustomPostProcessInjectionPoint.AfterPostProcess)]
public class StripesEffectRenderer : CustomPostProcessRenderer
{
    // A variable to hold a reference to the corresponding volume component (you can define as many as you like)
    StripesEffect m_VolumeComponent;
    ...
    float timeElapsed, previousFrameTime;

    // Initialized is called only once before the first render call
    // so we use it to create our material and initialize variables
    public override void Initialize()
    {
        m_Material = CoreUtils.CreateEngineMaterial("Shader Graphs/PostFxGraph");
        timeElapsed = 0;
    ...
    public override bool Setup(ref RenderingData renderingData, CustomPostProcessInjectionPoint injectionPoint)
    {
        ...
        m_VolumeComponent = stack.GetComponent<StripesEffect>();
